...
<div class="container pb-4" style="margin-top: 150px;">
  ...
  <form class="needs-validation" novalidate method="post" action="<?= base_url() . 'checkout/product/' . $product->product_id ?>">
        ...
        <table class="table table-bordered table-hover rounded w-100">
          ...
          <tbody style="background-color: white;">
            <tr>
              ...
              <td class="text-center">₱<?= $product->price * $quantity ?></td>
            </tr>
            <tr>
              <td colspan="3"></td>
              <td class="text-end">Total:</td>
              <td class="text-center fw-bold">₱<?= $product->price * $quantity ?></td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="mt-5 shadow-lg rounded p-5 pb-2 mb-4" style="background-color: #faf9f6;">
      ...
      <div class="mb-3">
        ...
        <select id="payment_method" name="payment_method" class="form-select">
          ...
          <option value="online" <?= ($product->price * $quantity) < 20 ? "disabled" : "" ?>>Pay Online in Advance</option>
        </select>
      </div>
      <div class="mb-3">
