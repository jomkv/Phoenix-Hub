...
<div id="organization-carousel-mobile" class="d-block d-md-none" style="background-color: red;">
  <h1>mobile</h1>
</div>

<div id="organization-carousel" class="carousel carousel-dark slide p-5 text-center bg-light mx-auto d-none d-md-block" style="border: 1px solid black;">
  <div class="carousel-indicators">
    ...
    <button type="button" data-bs-target="#organization-carousel" data-bs-slide-to="2" aria-label="Slide 3"></button>
  </div>
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#organization-carousel" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="#organization-carousel" data-bs-slide="next">
